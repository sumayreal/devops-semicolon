<%@ Page Title = "Main page" Language = "C#" MasterPageFile = "~/Homepage.master" AutoEventWireup = "true"  EnableEventValidation="False" CodeFile = "Board_Main.aspx.cs" Inherits = "Board" %>
